        ...
        <div className={'relative w-full'}>
          <Trigger asChild>
            <button
              ...
              className={cn(
                'pointer-cursor relative flex flex-col rounded-lg border border-black/10 bg-white py-2 pl-3 pr-10 text-left focus:ring-0 focus:ring-offset-0 dark:border-white/[0.08] dark:bg-white/[0.05] sm:text-sm',
          ...
          <Portal>
            <Content
              ...
              align="start"
              className={cn(
                'mr-3 mt-2 max-h-[52vh] w-full max-w-[85vw] overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-lg dark:border-white/[0.08] dark:bg-[#0F172A]/95 dark:backdrop-blur-xl dark:text-white sm:max-w-full lg:max-h-[52vh]',

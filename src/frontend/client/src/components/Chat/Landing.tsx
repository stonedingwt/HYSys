...
export default function Landing({ Header, isNew, lingsi, lingsiEntry, setLingsi }: { Header?: ReactNode; isNew?: boolean, lingsi: boolean, lingsiEntry?: any, setLingsi?: (v: boolean) => void }) {

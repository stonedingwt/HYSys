...
export default function Message(props: TMessageProps) {
  ...
  return (
    <>
      ...
      >
        <div className="flex w-full p-4 py-2 md:gap-6">
          <div className="group mr-auto flex gap-3 max-w-full px-0">
            <div className="relative flex flex-shrink-0 flex-col items-end pt-1">
              <div className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full shadow-sm bg-gray-100 dark:bg-gray-700 ring-1 ring-gray-200 dark:ring-gray-600">

      ...
      >
          ...
          <div className="relative">
            ...
            <label
              ...
              className="
                ...
                peer-focus:top-1.5 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-blue-600 dark:peer-focus:text-blue-400
        ...
        <div className="mt-6">
          <button
            ...
            type="submit"
            className="
            w-full rounded-2xl bg-blue-500 px-4 py-3 text-sm font-medium text-white
            transition-all duration-150 hover:bg-blue-600 hover:shadow-sm active:scale-[0.98]
          "
          >

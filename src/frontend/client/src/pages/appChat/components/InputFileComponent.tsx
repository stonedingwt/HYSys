...
export default function InputFileComponent({
    ...
    const checkFileSize = (file) => {
        const maxSize = (mepConfig?.uploaded_files_maximum_size || 50) * 1024 * 1024;
        if (file.size > maxSize) {
            return t('com_inputfile_exceed_limit', { 0: file.name, 1: (mepConfig?.uploaded_files_maximum_size || 50) })
        }
        return ''
    }

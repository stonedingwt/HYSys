    ...
    return <Select open={open} onOpenChange={setOpen}>
        ...
        <SelectContent auto>
            {cols.length
                ...
                : <div className="w-full flex justify-center items-center mep-label">空</div>
            }
        </SelectContent>
    </Select>
};

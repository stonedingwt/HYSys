            ...
            <PopoverPrimitive.Root open={open} onOpenChange={setOpen}>
                ...
                <PopoverPrimitive.Portal>
                    <PopoverPrimitive.Content
                        className={cname(
                            "z-50 w-full min-w-[var(--radix-popover-trigger-width)] rounded-md border dark:border-white/[0.08] bg-popover dark:bg-[#0A0F1E]/95 dark:backdrop-blur-xl p-0 text-popover-foreground shadow-md outline-none",

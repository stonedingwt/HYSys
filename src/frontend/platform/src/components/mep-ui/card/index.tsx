...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cname(
            "rounded-md bg-card text-card-foreground border border-transparent hover:shadow-[0_8px_16px_0px_rgba(40,47,84,0.15)] hover:border-[#EDF0F4] dark:hover:border-white/[0.08] relative hover:z-10",
            className
        )}
        {...props}
    />

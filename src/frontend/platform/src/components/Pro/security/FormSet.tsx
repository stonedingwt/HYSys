...
export default function FormSet({ data, onChange, onSave, onCancel }) {
    ...
    return <>
        <div className="px-4 mt-6">
            <span className="mep-label">{t('build.reviewType')}</span>
            <RadioGroup value="1"
            ...
            <div className="mb-6">
                <span className="mep-label">{t('build.wordListType')}</span>
            ...
            <span className="mep-label">{t('build.autoReplyContent')}</span>

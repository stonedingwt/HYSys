import { Alert, AlertDescription } from '@/components/mep-ui/alert';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/mep-ui/card';
import Skeleton from '@/components/mep-ui/skeleton';
  ...
  return (
    <section className='pb-20 max-w-[1600px]'>
      ...
      <div className='flex gap-2 mb-4'>
        <Card className={`w-1/2 dark:bg-navy-900 cursor-pointer border-2 ${embed ? '' : 'border-primary hover:border-primary dark:hover:border-primary'}`} onClick={() => setEmbed(false)}>
          <CardHeader className='pt-2 pb-0'>
        ...
        <Card className={`w-1/2 dark:bg-navy-900 cursor-pointer border-2 ${embed ? 'border-primary hover:border-primary dark:hover:border-primary' : ''}`} onClick={() => setEmbed(true)}>
          <CardHeader className='pt-2 pb-0'>

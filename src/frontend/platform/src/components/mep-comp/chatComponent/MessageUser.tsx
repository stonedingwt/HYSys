import { FlagIcon } from "@/components/mep-icons";
        ...
        <div className="w-fit group min-h-8 max-w-[90%]">
            ...
            <div className="rounded-2xl px-6 py-4 bg-[#EEF2FF] dark:bg-[#333A48]">
                <div className="flex gap-2 ">
                    ...
                    <div className="w-6 h-6 min-w-6"><img src={(window as any).ThemeStyle?.logos?.['user-avatar'] || __APP_ENV__.BASE_URL + '/assets/user.png'} alt="" /></div>
                </div>
            </div>
            {/* 附加信息 */}
            {

import CardComponent from "@/components/mep-comp/cardComponent";
import AppAvator from "@/components/mep-comp/cardComponent/avatar";
import LabelShow from "@/components/mep-comp/cardComponent/LabelShow";
import AppTempSheet from "@/components/mep-comp/sheets/AppTempSheet";
import { LoadingIcon } from "@/components/mep-icons/loading";
import { MoveOneIcon } from "@/components/mep-icons/moveOne";
...
import { Select, SelectContent, SelectGroup, SelectItem, SelectTrigger, SelectValue } from "@/components/mep-ui/select";
import SelectSearch from "@/components/mep-ui/select/select";
...
export default function apps() {
    ...
    return <div className="h-full relative">
        <div className="px-10 py-6 h-full overflow-y-scroll scrollbar-hide relative">
        ...
        {/* footer */}
        <div className="flex justify-between absolute bottom-0 left-0 w-full bg-background-main-content h-16 items-center px-10">

        ...
        return (
            <div className="flex items-center gap-2 h-12">
                <NavLink to="build/apps" className={tabClass}>
                    <TabIcon className="text-slate-400 group-hover:text-cyan-500 dark:group-hover:text-cyan-400" />

...
export default function EditAssistantDialog({ logo, viewLogo, name, desc, onSave, loca }) {
    ...
    return <DialogContent className="sm:max-w-[625px] bg-background-login">
        ...
        <div className="flex flex-col gap-8 py-6">
            <div className="">
                <label htmlFor="name" className="mep-label">{t('build.assistantAvatar')}<span className="mep-tip">*</span></label>
                <Avator
                    value={previewAvatar}
                    className="mt-2"
            ...
            <div className="">
                <label htmlFor="desc" className="mep-label">{t('build.assistantDesc')}</label>
                <Textarea
                    id="desc"
                    name="desc"

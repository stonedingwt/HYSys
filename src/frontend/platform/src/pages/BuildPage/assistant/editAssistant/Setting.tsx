...
import { TitleIconBg } from "@/components/mep-comp/cardComponent";
import AppAvator from "@/components/mep-comp/cardComponent/avatar";
import KnowledgeSelect from "@/components/mep-comp/selectComponent/knowledge";
import SkillSheet from "@/components/mep-comp/sheets/SkillSheet";
import ToolsSheet from "@/components/mep-comp/sheets/ToolsSheet";
import { ToolIcon } from "@/components/mep-icons/tool";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { Input, InputList, Textarea } from "@/components/mep-ui/input";
import {
  QuestionTooltip,
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@/components/mep-ui/tooltip";
    ...
    >
      ...
      <Accordion type="multiple" className="w-full">
        ...
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="py-2">
            <div className="mb-4 px-6">
              <label htmlFor="model" className="mep-label">
                {t("build.model")}
              </label>
              <ModelSelect
            ...
            <div className="mb-4 px-6">
              <label htmlFor="slider" className="mep-label">
                {t("build.temperature")}
              </label>
              <Temperature
            ...
            <div className="mb-4 px-6">
              <label htmlFor="slider" className="mep-label flex gap-1">
                {t("build.maxToken")}
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="py-2">
            <div className="mb-4 px-6">
              <label htmlFor="open" className="mep-label">
            ...
            <div className="mb-4 px-6">
              <label htmlFor="open" className="mep-label flex gap-1">
            ...
            <div className="flex flex-1 items-center justify-between">
              ...
              <PopoverContent className="w-[560px]">
                  <div className="flex justify-between">
                      <label htmlFor="model" className="mep-label">{t('build.callingMethod')}</label>
                      <div>

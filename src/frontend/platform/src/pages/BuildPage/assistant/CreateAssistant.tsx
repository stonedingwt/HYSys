import { AssistantIcon } from "@/components/mep-icons";
...
import { DialogClose, DialogContent, DialogFooter, DialogHeader, DialogTitle } from "../../../components/mep-ui/dialog";
...
3. …`
    ...
    return <DialogContent className="sm:max-w-[625px] bg-background-login">
        ...
        <div className="flex flex-col gap-8 py-6">
            <div className="">
                <label htmlFor="name" className="mep-label">{t('build.assistantAvatar')}</label>
            ...
            <div className="">
                <label htmlFor="name" className="mep-label">{t('build.assistantName')}<span className="mep-tip">*</span></label>
            ...
            <div className="">
                <label htmlFor="roleAndTasks" className="mep-label">{t('build.whatWant')}</label>
                <Textarea
                    id="roleAndTasks"
                    name="roleAndTasks"
                ...
                />
                {errors.roleAndTasks && <p className="mep-tip mt-1">{errors.roleAndTasks}</p>}
            </div>
        </div>
        <DialogFooter>
            <DialogClose>

...
export const ChatTest = forwardRef((props, ref) => {
    ...
    return (
        <div
            ref={resizableRef}
            className={`${small ? 'bottom-2 right-4 w-52' : 'h-full right-0 bottom-0'} transition-all fixed rounded-2xl bg-[#fff] dark:bg-navy-800 z-10 border shadow-sm overflow-hidden`}

...
import { Sheet, SheetClose, SheetContent, SheetFooter, SheetHeader, SheetTitle } from "@/components/mep-ui/sheet";
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            >
                ...
                <div className="px-2 pt-2 pb-10 h-[calc(100vh-40px)] overflow-y-auto bg-[#fff] dark:bg-navy-800">
                    {inputs.map((input) => (

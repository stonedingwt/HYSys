...
export default function RunLog({ node, children }) {
    ...
    if (state === Status.success) return (
        <div className='mep-node-top flex justify-between bg-[#E6FBF1] dark:bg-navy-800'>
    ...
    return (
        <div className='mep-node-top flex justify-between bg-[#FCEAEA] dark:bg-navy-800'>
            <div className='flex items-center gap-2 text-sm'>
...
const Log = ({ type, name, data }) => {
    ...
    return (
        <div className="relative" ref={ref}>
            ...
            {open && (
                <div className="absolute top-0 left-full w-96 rounded-lg shadow-lg p-2 bg-[#F7F8FB] dark:bg-navy-800 z-10">

...
function Form({ nodeId, nodeData, initialData, onSubmit, onCancel, existingOptions }) {
    ...
    const InputForm = <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
            <Label className="mep-label">{t('isRequired')}</Label>
            <Switch
    ...
    const SelectForm = <div className="space-y-4">
        ...
        <div>
            <Label className="mep-label">{t("options")}</Label>
        ...
        <div className="flex items-center space-x-2">
            <Label className="mep-label">{t('allowMultipleSelect')}</Label>
            <Switch
    ...
    const FileForm = <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
            <Label className="mep-label">{t('allowUploadMultipleFiles')}</Label>
            <Switch
    ...
    return (
        <form onSubmit={handleFormSubmit} className="space-y-4">
            <div>
                <Label className="mep-label">{t("formType")}</Label>

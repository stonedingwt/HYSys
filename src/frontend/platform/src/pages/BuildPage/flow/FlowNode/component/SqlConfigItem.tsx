...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/mep-ui/select";
    ...
    return (
        <div className="node-item mb-4 relative" data-key={data.key}>
            ...
            {open && (
                <>
                    {/* 数据库类型下拉框 */}
                    <Label className="flex items-center mep-label">{t("dbType")}</Label>
                    <Select
                        value={database_engine}
                    ...
                    {/* 数据库地址 */}
                    <Label className="flex items-center mep-label">{t("dbAddress")}</Label> {/* 数据库地址 */}
                    <Input
                    ...
                    {/* 数据库名称 */}
                    <Label className="flex items-center mep-label mt-4">{t("dbName")}</Label> {/* 数据库名称 */}
                    <Input
                    ...
                    {/* 数据库用户名 */}
                    <Label className="flex items-center mep-label mt-4">{t("dbUsername")}</Label> {/* 数据库用户名 */}
                    <Input
                    ...
                    {/* 数据库密码 */}
                    <Label className="flex items-center mep-label mt-4">{t("dbPassword")}</Label> {/* 数据库密码 */}
                    <Input

...
import { LoadIcon } from "@/components/mep-icons/loading";
import { Accordion } from "@/components/mep-ui/accordion";
...
import Avator from "@/components/mep-ui/input/avator";
        ...
        useImperativeHandle(ref, () => ({
            open(type: AppType, tempId?: number) {
                ...
                setFormData({
                    url: '',
                    name: '',
                    desc: AppType.ASSISTANT === type ? `${t('build.example', { ns: 'mep' })}：
${t('build.exampleOne', { ns: 'mep' })}
${t('build.exampleTwo', { ns: 'mep' })}
1. XX
2. XX
3. …` : '',
                });
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-[625px] bg-background-login">
                    ...
                    <div className="flex flex-col mt-2">
                        <div className="mb-6">
                            <label htmlFor="name" className="mep-label">
                        ...
                        <div className="mb-6">
                            ...
                            />
                            {errors.name && <p className="mep-tip mt-1">{errors.name}</p>}
                        </div>
                        <div className="mb-6">
                            <label htmlFor="desc" className="mep-label">
                            ...
                            <Textarea
                                ...
                                onChange={handleChange}
                            />
                            {errors.desc && <p className="mep-tip mt-1">{errors.desc}</p>}
                        </div>
                    </div>

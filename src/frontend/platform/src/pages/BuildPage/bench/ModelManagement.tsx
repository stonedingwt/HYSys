        ...
        return (
            <div className="mt-2 border p-4 rounded-md bg-muted">
                <div className="grid mb-4 items-center" style={{ gridTemplateColumns: "1fr 1fr 120px 60px" }}>
                    <div className="">
                        <Label className="mep-label">{t('bench.model')}</Label>
                    </div>
                    <div className="">
                        <Label className="mep-label">{t('bench.displayName')}</Label>
                    </div>
                    <div className="flex items-center justify-center">
                        <Label className="mep-label whitespace-nowrap mr-0.5">{t('bench.vision')}</Label>

...
import SimpleUpload from "@/components/mep-ui/upload/simple";
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="sm:max-w-[625px]">
                ...
                <div className="flex flex-col gap-4 py-2">
                    <div>
                        <label htmlFor="dataSetName" className="mep-label">
                    ...
                    <div>
                        <label htmlFor="importMethod" className="mep-label">{t('dataset.importMethod')}</label>
                        <RadioGroup
                            defaultValue="local"
                    ...
                    {form.importMethod === 'local' && (
                        <div>
                            <div className="flex justify-between items-center">
                                <label htmlFor="fileUpload" className="mep-label">
                    ...
                    {form.importMethod === 'qa' && (
                        <div>
                            <label htmlFor="knowledgeLib" className="mep-label">

import FileView from "@/components/mep-comp/FileView";
        ...
        <div className="flex px-4 py-2 select-none">
            ...
            <div className="relative" style={{ width: leftPanelWidth }}>
                ...
                {!isUns && <div className="flex justify-end gap-4">
                    <Button className="px-6 h-8" variant="outline" onClick={onClose}>{t('cancel', { ns: 'mep' })}</Button>
                    <Button className="px-6 h-8" disabled={loading} onClick={handleSave}><LoadIcon className={`mr-1 ${loading ? '' : 'hidden'}`} />{t('save', { ns: 'mep' })}</Button>
                </div>}
            </div>
            {isUns && <>
                {/* drag line */}
                ...
                <div className="flex-1 min-w-0 w-0">
                    ...
                    <div className="flex justify-between items-center relative h-10 mb-2 text-sm">
                        ...
                        <div className="flex justify-end gap-4">
                            {edit && <Button className="px-6 h-8" variant="outline" onClick={onClose}>{t('cancel', { ns: 'mep' })}</Button>}
                            {edit && <Button className="px-6 h-8" disabled={loading} onClick={handleSave}><LoadIcon className={`mr-1 ${loading ? '' : 'hidden'}`} />{t('save', { ns: 'mep' })}</Button>}

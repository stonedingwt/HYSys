import { checkSassUrl } from "@/components/mep-comp/FileView";
...
import { Button, LoadButton } from "../../components/mep-ui/button";
import { Input, InputList, SearchInput, Textarea } from "../../components/mep-ui/input";
        ...
        <Dialog open={open} onOpenChange={(bln) => bln ? setOpen(bln) : close()}>
            <DialogContent className="sm:max-w-[625px]">
                ...
                <div className="flex flex-col gap-4 py-2">
                    <div>
                        <label htmlFor="question" className="mep-label">
                    ...
                    <div>
                        <label htmlFor="similarQuestions" className="mep-label">{t('similarQuestions')}</label>
                        <InputList
                    ...
                    <div>
                        <label htmlFor="answer" className="mep-label">
...
export default function QasPage() {
    ...
    return (
        <div className="relative px-2 pt-4 size-full">
            ...
            <div className="mep-table-footer px-6 justify-end">
                <div>
                    <AutoPagination
                        page={page}
                        pageSize={pageSize}

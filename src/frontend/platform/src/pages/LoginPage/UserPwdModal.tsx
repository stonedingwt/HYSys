...
import { PasswordInput } from "@/components/mep-ui/input";
        ...
        <Dialog open={editShow} onOpenChange={setEditShow}>
            <DialogContent className="sm:max-w-[625px]">
                ...
                <div className="flex flex-col gap-8 py-6">
                    <div>
                        <label htmlFor="password" className="mep-label">{t('resetPassword.newPassword')}<span className="mep-tip">*</span></label>
                        <PasswordInput
                            ref={passwordRef}
                            id="password"
                            name="password"
                        ...
                        />
                        {error && <p className="mep-tip mt-1">{error}</p>}
                    </div>
                </div>
                <DialogFooter>
                    <DialogClose>

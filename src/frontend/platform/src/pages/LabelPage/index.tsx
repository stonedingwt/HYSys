import UsersSelect from "@/components/mep-comp/selectComponent/Users";
...
import { TableHeadEnumFilter } from "@/components/mep-ui/select/filter";
    ...
    return <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[625px]">
            ...
            <div className="flex flex-col gap-4 py-2">
                <div className="">
                    <label htmlFor="name" className="mep-label">{t('label.selectAppsToLabel')}</label>
                    <MultiSelect
                ...
                <div className="">
                    <label htmlFor="name" className="mep-label">{t('label.selectLabelers')}</label>
                    <UsersSelect
                        multiple
                        value={users}
                        onChange={setUsers}
...
export default function Tasks() {
    ...
    return (
        <div className="relative px-2 pt-4 h-full">
            ...
            <div className="mep-table-footer bg-background-login px-2">
                <AutoPagination

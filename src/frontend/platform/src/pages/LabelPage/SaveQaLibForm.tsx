        ...
        <Dialog open={open} onOpenChange={(bln) => bln ? setOpen(bln) : close()}>
            <DialogContent className="sm:max-w-[625px]">
                ...
                <div className="flex flex-col gap-4 py-2">
                    <div>
                        <label htmlFor="knowledgeLib" className="mep-label"><span className="text-red-500">*</span>{t('log.qaKnowledgeLib')}</label>
                        <KnowledgeSelect
                            type="qa"
                    ...
                    <div>
                        <label htmlFor="question" className="mep-label"><span className="text-red-500">*</span>{t('log.question')}</label>
                        <Input name="question" className={`col-span-3 ${error.question && 'border-red-400'}`} value={form.question} onChange={handleInputChange} />
                    </div>
                    <div>
                        <label htmlFor="similarQuestions" className="mep-label">{t('log.similarQuestions')}</label>
                    ...
                    <div>
                        <label htmlFor="answer" className="mep-label"><span className="text-red-500">*</span>{t('log.answer')}</label>

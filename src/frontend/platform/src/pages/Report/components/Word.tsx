    ...
    const editorConfig = {
        ...
        editorConfig: {
            ...
            customization: {
                ...
                uiTheme: "theme-dark",
                logo: {
                    "image": location.origin + (window.ThemeStyle?.logos?.['logo-report'] || __APP_ENV__.BASE_URL + "/assets/mep/logo.jpeg"),
                    "imageDark": location.origin + (window.ThemeStyle?.logos?.['logo-report'] || __APP_ENV__.BASE_URL + "/assets/mep/logo.jpeg"),

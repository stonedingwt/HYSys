...
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from "@/components/mep-ui/dialog";
    ...
    return (
        <div className="group w-full border rounded-sm p-4 mb-2">
            ...
            <div className="space-y-2 mt-2">
                ...
                <div>
                    <Label className="mep-label">{t('model.modelType')}</Label>
...
const mepModelProvider = { "name": "mepRT", "value": "mep_rt" }
...
export default function ModelConfig({ id, onGetName, onBack, onReload, onBerforSave, onAfterSave }) {
    ...
    const _modelProvider = useMemo(() => {
        return id === -1 ? modelProvider : [...modelProvider, mepModelProvider]
    }, [id])
    ...
    return <div className="relative size-full py-4">
        <div className="flex ml-6 items-center gap-x-3">
            <ShadTooltip content={t('back', { ns: 'mep' })} side="right">
        ...
        <div className="w-[50%] min-w-64 px-4 pb-10 mx-auto mt-6 h-[calc(100vh-220px)] overflow-y-auto">
            <div className="mb-2">
                <Label className="mep-label"> {t('model.interModelFormat')}</Label>

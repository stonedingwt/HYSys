...
import { ToggleGroup, ToggleGroupItem } from "../../../components/mep-ui/toggle-group";
...
export default function FinetuneHead({ onSearch, onFilter, rtClick, onCreate }: IProps) {
    ...
    return <div className="flex justify-between pb-4 border-b ml-2">
        ...
        <div className="flex gap-4 mr-2">
            ...
            <Button variant="black" className="dark:text-[#ECECEC] dark:bg-navy-800" onClick={rtClick}>{t('finetune.rtServiceManagement')}</Button>
        </div>
    </div>
};

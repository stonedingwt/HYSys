...
from mep.workflow.nodes.report.text_classification import Patterns
from mep.workflow.nodes.report.text_classification import TextClassificationReport
...
/mep/tmp1.png?dadsaa=adas /mep/tmp2.png
...
class TestDocxStringClassification(TestCase):
    def setUp(self):
        self.text_classification = TextClassificationReport("/tmp/mep")

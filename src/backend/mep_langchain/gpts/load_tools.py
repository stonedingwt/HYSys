...
from mep_langchain.gpts.tools.api_tools import ALL_API_TOOLS
from mep_langchain.gpts.tools.bing_search.self_arxiv import ArxivAPIWrapperSelf
from mep_langchain.gpts.tools.bing_search.tool import BingSearchResults
from mep_langchain.gpts.tools.calculator.tool import calculator
from mep_langchain.gpts.tools.code_interpreter.e2b_executor import E2bCodeExecutor
from mep_langchain.gpts.tools.code_interpreter.local_executor import LocalExecutor
from mep_langchain.gpts.tools.code_interpreter.tool import CodeInterpreterTool
# from langchain_community.utilities.dalle_image_generator import DallEAPIWrapper
from mep_langchain.gpts.tools.dalle_image_generator.tool import (
    DallEImageGenerator, ProxyDallEAPIWrapper,
)
from mep_langchain.gpts.tools.get_current_time.tool import get_current_time
...
_EXTRA_PARAM_TOOLS: Dict[str, Tuple[Callable[[KwArg(Any)], BaseTool], List[Optional[str]], List[Optional[str]]]] = {
    ...
    'mep_code_interpreter': (_get_native_code_interpreter, ["minio"], ['config', 'type']),
    'mep_rag': (MEPRAGTool.get_rag_tool, ['name', 'description'],

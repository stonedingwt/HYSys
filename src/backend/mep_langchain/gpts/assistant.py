...
import httpx
import yaml
from mep_langchain.gpts.load_tools import get_all_tool_names, load_tools
from mep_langchain.gpts.utils import import_by_type, import_class
    ...
    def __init__(
        ...
        **others: Any,
        ...
        agent_executor_object = import_class(
            f'mep_langchain.gpts.agent_types.{agent_executor_type}')
...
class MEPAssistant:
    ...
    def __init__(self, yaml_path) -> None:
        ...
        assistant_message = import_class(f'mep_langchain.gpts.prompts.{prompt_type}')
...
if __name__ == '__main__':
    ...
    mep_assistant = MEPAssistant('config/base_scene.yaml')
    # mep_assistant = MEPAssistant("config/knowledge_scene.yaml")
    # mep_assistant = MEPAssistant("config/rag_scene.yaml")
    result = mep_assistant.run(query, chat_history=chat_history)
    print(result)

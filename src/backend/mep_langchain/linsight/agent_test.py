...
from mep_langchain.linsight.const import TaskMode, ExecConfig
from mep_langchain.linsight.event import NeedUserInput, TaskStart, TaskEnd, ExecStep


async def get_linsight_agent():
    azure_api_key = os.environ.get('azure_api_key')
    qwen_api_key = os.environ.get('qwen_api_key')
    root_path = "/Users/zhangguoqing/works/mep/src/backend/mep_langchain/linsight/data"
...
（本SOP适用于批量文本简历基于技术与素质条件的快速筛查任务）"""
    task_info = [
        {'step_id': 'step_1', 'description': '获取指定目录下所有txt格式的简历文件路径。', 'profile': '文件检索机器人',
         'target': '列出/Users/zhangguoqing/works/mep/src/backend/mep_langchain/linsight/data下的所有txt格式简历文件路径',
         'sop': '使用@list_files工具，检索所给目录下所有txt文件，返回完整路径列表。',
         'prompt': '请使用@list_files工具列出/Users/zhangguoqing/works/mep/src/backend/mep_langchain/linsight/data目录下所有txt后缀简历文件的路径。',

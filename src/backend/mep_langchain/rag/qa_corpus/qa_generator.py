...
from mep_langchain.document_loaders import ElemUnstructuredLoader
try:
    from mep_ragas.trainset import TrainsetGenerator
except (ImportError, ModuleNotFoundError):
    TrainsetGenerator = None
...
class RagQAGenerator(object):
    ...
    def __init__(self, 
                 corpus_folder,
                 qa_gen_folder,
                 unstructured_api_url="https://mep.dataelem.com/api/v1/etl4llm/predict",

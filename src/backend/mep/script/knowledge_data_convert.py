...
from mep.knowledge.domain.models.knowledge import Knowledge, KnowledgeDao, KnowledgeTypeEnum
from mep.knowledge.domain.models.knowledge_file import KnowledgeFile
from mep.llm.domain import LLMService
from mep.script.knowledge_data_fix import get_all_knowledge_files, _get_milvus_chunks_data, _get_es_chunks_data
...
def convert_milvus_data(knowledge: Knowledge, all_file: List[KnowledgeFile], new_collection_name: str):
    ...
    embedding = LLMService.get_mep_knowledge_embedding_sync(0, model_id=int(knowledge.model))

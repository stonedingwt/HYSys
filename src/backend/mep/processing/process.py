...
from mep.database.models.report import Report as ReportModel
from mep.interface.run import build_sorted_vertices, get_memory_key, update_memory_keys
from mep.services.deps import get_session_service
from mep.template.field.base import TemplateField
from mep.utils.docx_temp import test_replace_string
from mep_langchain.input_output import Report
...
def get_result_and_thought(langchain_object: Any, inputs: dict):
    ...
    try:
        ...
        try:
            ...
            # action = 'default'
            from mep.api.v1 import callback

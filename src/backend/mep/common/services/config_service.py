...
from mep.common.models.config import ConfigKeyEnum, Config
from mep.common.repositories.implementations.config_repository_impl import ConfigRepositoryImpl
from mep.core.cache.redis_manager import get_redis_client_sync
from mep.core.config.settings import Settings, PasswordConf, SystemLoginMethod, \
...
class ConfigService(Settings):
    ...
    def get_system_login_method(self) -> SystemLoginMethod:
        ...
        tmp.mep_pro = os.getenv('MEP_PRO') == 'true'
        return tmp

...
from mep.knowledge.domain.models.knowledge import Knowledge, KnowledgeDao, KnowledgeState
...
def _rebuild_embeddings(knowledge: Knowledge, files: List[KnowledgeFile], new_model_id: int, invoke_user_id: int) -> \
    ...
    try:
        ...
        new_embeddings = LLMService.get_mep_knowledge_embedding_sync(model_id=new_model_id,

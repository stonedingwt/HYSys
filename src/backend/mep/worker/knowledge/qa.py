...
from mep.api.services.knowledge_imp import QA_save_knowledge, decide_vectorstores
...
from mep.knowledge.domain.models.knowledge import KnowledgeDao, KnowledgeState
...
from mep_langchain.vectorstores import Milvus, ElasticKeywordsSearch
...
def rebuild_qa_knowledge_celery(knowledge_id: int, embedding_model_id: int, invoke_user_id: int):
    ...
    try:
        ...
        embeddings = LLMService.get_mep_knowledge_embedding_sync(model_id=embedding_model_id,

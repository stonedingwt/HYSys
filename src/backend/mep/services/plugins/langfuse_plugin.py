...
from mep.services.deps import get_settings_service
from mep.services.plugins.base import CallbackPlugin
    ...
    def get_callback(self, _id: Optional[str] = None):
        ...
        try:
            ...
            if langfuse_instance is not None and hasattr(langfuse_instance, 'trace'):
                trace = langfuse_instance.trace(CreateTrace(name='mep-' + _id, id=_id))
                if trace:

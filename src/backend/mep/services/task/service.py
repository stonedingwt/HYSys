...
from mep.services.task.backends.anyio import AnyIOBackend
from mep.services.task.backends.base import TaskBackend
...
class TaskService(Service):
    ...
    def get_backend(self) -> TaskBackend:
        if USE_CELERY:
            from mep.services.task.backends.celery import CeleryBackend

# from mep.services.auth.utils import create_super_user, verify_password
# from mep.services.database.utils import initialize_database
from mep.services.manager import service_manager
# from mep.services.settings.constants import DEFAULT_SUPERUSER, DEFAULT_SUPERUSER_PASSWORD
from loguru import logger


def get_factories_and_deps():
    # from mep.services.auth import factory as auth_factory
    # from mep.services.cache import factory as cache_factory
    # from mep.services.chat import factory as chat_factory
    # from mep.services.credentials import factory as credentials_factory
    # from mep.services.database import factory as database_factory
    # from mep.services.plugins import factory as plugins_factory
    from mep.services.session import factory as session_service_factory  # type: ignore
    # from mep.services.settings import factory as settings_factory
    # from mep.services.store import factory as store_factory
...
#     from mep.services.database.models.user.model import User

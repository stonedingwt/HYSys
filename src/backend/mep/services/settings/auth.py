...
from mep.services.settings.utils import read_secret_from_file, write_secret_to_file
...
class AuthSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(validate_assignment=True, extra='ignore', env_prefix='mep_')

...
if TYPE_CHECKING:
    from mep.services.store.schema import ListComponentResponse
...
# Get the latest released version of mep (https://pypi.org/project/mep/)
def get_lf_version_from_pypi():
    try:
        response = httpx.get('https://pypi.org/pypi/mep/json')

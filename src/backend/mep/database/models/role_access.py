...
class WebMenuResource(Enum):
    ...
    WS_APPS = 'ws_apps'  # Workspace: App Center
    WS_NEW_CHAT = 'ws_new_chat'  # Workspace: New Chat (NingYi Assistant)
    WS_NINGYI_ASSISTANT = 'ws_ningyi_assistant'  # Workspace: Follow-up Assistant

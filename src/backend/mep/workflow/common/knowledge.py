...
from mep.knowledge.domain.models.knowledge import Knowledge, MetadataFieldType
...
from mep.workflow.common.condition import ComparisonType
...
class RagUtils(BaseNode):
    ...
    def init_rerank_model(self):
        ...
        if self._rerank_model:
            return
        self._rerank_model = LLMService.get_mep_rerank_sync(model_id=self._rerank_model_id,

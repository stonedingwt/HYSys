...
from mep.workflow.nodes.output.output_fake import OutputFakeNode
...
class GraphEngine:
    ...
    def build_nodes(self):
        ...
        # import datetime
        # with open(f"./mep/data/graph/graph_{datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.png",
        #           'wb') as f:

...
from mep.api.services.knowledge_imp import read_chunk_text
...
from mep.common.errcode.knowledge import KnowledgeFileNotSupportedError
...
from mep.workflow.callback.event import GuideQuestionData
from mep.workflow.nodes.base import BaseNode
from mep.workflow.nodes.input.const import InputFileMetadata
...
class InputNode(BaseNode):
    ...
    def handle_recommended_questions(self):
        ...
        llm_obj = LLMService.get_mep_llm_sync(model_id=recommended_llm,

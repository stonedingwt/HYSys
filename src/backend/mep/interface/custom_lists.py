...
from mep.interface.agents.custom import CUSTOM_AGENTS
from mep.interface.chains.custom import CUSTOM_CHAINS
from mep.interface.embeddings.custom import CUSTOM_EMBEDDING
from mep.interface.importing.utils import import_class
from mep_langchain import chat_models
from mep_langchain import document_loaders as contribute_loader
from mep_langchain import embeddings as contribute_embeddings
...
llm_type_to_cls_dict.update({
    llm_name: import_class(f'mep_langchain.chat_models.{llm_name}')
...
embedding_type_to_cls_dict.update({
    embedding_name:
        import_class(f'mep_langchain.embeddings.{embedding_name}')
...
documentloaders_type_to_cls_dict.update({
    loader:
        import_class(f'mep_langchain.document_loaders.{loader}')

...
from mep.template.frontend_node.input_output import InputOutputNode
from loguru import logger
from mep.utils.util import build_template_from_class
from mep_langchain import input_output
...
class IOutputCreator(LangChainTypeCreator):
    ...
    def type_to_loader_dict(self) -> Dict:
        if self.type_dict is None:
            ...
            # mep-langchain
            mep = {
                node_name: import_class(f'mep_langchain.input_output.{node_name}')

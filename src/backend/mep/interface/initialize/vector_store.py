...
from mep_langchain.vectorstores import ElasticKeywordsSearch
...
def initial_milvus(class_object: Type[Milvus], params: dict, search_kwargs: dict):
    ...
    if 'embedding' not in params:
        ...
        params['embedding'] = LLMService.get_mep_knowledge_embedding_sync(0, model_id=int(knowledge.model))

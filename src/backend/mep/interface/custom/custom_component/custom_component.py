...
import yaml
from mep.database.models.flow import Flow, FlowDao
from mep.interface.custom.code_parser.utils import (extract_inner_type_from_generic_alias,
                                                        extract_union_types_from_generic_alias)
from mep.interface.custom.custom_component.component import Component
...
class CustomComponent(Component):
    ...
    async def load_flow(self, flow_id: str, tweaks: Optional[dict] = None) -> Any:
        from mep.processing.process import build_sorted_vertices, process_tweaks

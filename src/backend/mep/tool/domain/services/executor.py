...
from mep.common.constants.enums.telemetry import BaseTelemetryTypeEnum, StatusEnum, ApplicationTypeEnum
from mep.common.schemas.telemetry.event_data_schema import ToolInvocationEventData
...
from mep.mcp_manage.langchain.tool import McpTool
from mep.mcp_manage.manager import ClientManager
from mep.tool.domain.const import ToolPresetType
from mep.tool.domain.langchain.knowledge import KnowledgeRagTool
from mep.tool.domain.models.gpts_tools import GptsToolsDao, GptsTools, GptsToolsType
from mep.tool.domain.services.openapi import OpenApiSchema
from mep_langchain.gpts.load_tools import load_tools
from mep_langchain.gpts.tools.api_tools.openapi import OpenApiTools
...
class ToolExecutor(BaseTool):
    ...
    def parse_preset_tool_params(tool: GptsTools, tool_type: GptsToolsType) -> Dict:
        ...
        # special handling for mep_code_interpreter, because it needs minio config
        if tool.tool_key == 'mep_code_interpreter':

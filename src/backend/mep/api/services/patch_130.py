...
from mep.api.services.md_from_docx import handler as docx_handler
from mep.api.services.md_from_excel import handler as excel_handler
from mep.api.services.md_from_html import handler as html_handler
from mep.api.services.md_from_pdf import handler as pdf_handler
from mep.api.services.md_from_pptx import handler as pptx_handler
from mep.api.services.md_post_processing import post_processing
from mep.core.cache.utils import CACHE_DIR
...
def replace_image_url(
    ...
    """
    from mep.api.services.knowledge_imp import KnowledgeUtils

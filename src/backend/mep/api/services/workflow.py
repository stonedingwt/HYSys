...
from mep.api.v1.schema.workflow import WorkflowEvent, WorkflowEventType, WorkflowInputSchema, WorkflowInputItem, \
    WorkflowOutputSchema
from mep.api.v1.schemas import ChatResponse
from mep.chat.utils import SourceType
...
from mep.common.errcode.flow import WorkFlowInitError
from mep.common.errcode.http_error import NotFoundError, UnAuthorizedError
from mep.common.services import telemetry_service
from mep.core.logger import trace_id_var
from mep.database.models.flow import FlowDao, FlowStatus, FlowType, Flow
from mep.database.models.flow import UserLinkType
...
from mep.database.models.tag import TagDao
from mep.database.models.user_link import UserLinkDao
...
from mep.workflow.common.node import BaseNodeData, NodeType
from mep.workflow.graph.graph_state import GraphState
from mep.workflow.graph.workflow import Workflow
from mep.workflow.nodes.node_manage import NodeFactory
...
class WorkFlowService(BaseService):
    ...
    async def update_flow_status(cls, login_user: UserPayload, flow_id: str, version_id: int, status: int):
        ...
        if status == FlowStatus.ONLINE.value:
            ...
            db_flow.data = version_info.data

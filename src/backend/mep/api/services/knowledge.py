...
from mep.api.services.knowledge_imp import (
    KnowledgeUtils,
    decide_vectorstores,
...
from mep.api.v1.schema.knowledge import KnowledgeFileResp
from mep.api.v1.schemas import (
    FileChunk,
    FileProcessBase,
    KnowledgeFileOne,
...
from mep.common.errcode.knowledge import (
    KnowledgeChunkError,
    KnowledgeExistError,
    KnowledgeNoEmbeddingError, KnowledgeNotQAError, KnowledgeFileFailedError,
)
from mep.common.schemas.telemetry.event_data_schema import NewKnowledgeBaseEventData
...
from mep.core.cache.utils import file_download, async_file_download
...
from mep.database.models.group_resource import (
    GroupResource,
    GroupResourceDao,
    ResourceTypeEnum,
)
...
from mep.knowledge.domain.models.knowledge import (
    Knowledge,
    KnowledgeCreate,
    KnowledgeDao,
    KnowledgeRead,
...
from mep.utils import generate_uuid, generate_knowledge_index_name
...
class KnowledgeService(KnowledgeUtils):
    ...
    def process_knowledge_file(
        ...
        from mep.worker.knowledge import file_worker
    ...
    async def copy_qa_knowledge(
        ...
        from mep.worker.knowledge.qa import copy_qa_knowledge_celery

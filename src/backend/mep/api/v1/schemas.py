...
from mep.database.models.assistant import AssistantBase
from mep.database.models.flow import FlowCreate, FlowRead
from mep.database.models.message import ChatMessageRead
from mep.database.models.tag import Tag
from mep.knowledge.domain.models.knowledge import KnowledgeRead
from mep.knowledge.domain.schemas.knowledge_rag_schema import Metadata
from mep.tool.domain.models.gpts_tools import GptsToolsRead
...
class WorkstationConfig(BaseModel):
    ...
    dailyChatFlowId: Optional[str] = Field(default=None, description='工作台宁伊助手关联的工作流ID，设置后宁伊助手将使用该工作流')
    followUpFlowId: Optional[str] = Field(default=None, description='工作台跟单助手关联的工作流ID，设置后跟单助手将使用该工作流')

...
from mep.database.models.user_group import UserGroup
from mep.user.domain.models.user_role import UserRole
...
class UserBase(SQLModelSerializable):
    ...
    user_type: Optional[str] = Field(default=None, index=True, description='User source type: dingtalk/wecom/feishu/aad/local')

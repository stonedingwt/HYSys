...
from mep.api.v1.schemas import resp_200, CreateUserReq
from mep.common.errcode.http_error import UnAuthorizedError, NotFoundError
from mep.common.errcode.user import (UserNotPasswordError, UserValidateError, UserPasswordError, UserForbiddenError)
from mep.common.services.config_service import settings
from mep.core.cache.redis_manager import get_redis_client, get_redis_client_sync
from mep.core.database import get_sync_db_session
from mep.database.constants import AdminRole, DefaultRole
from mep.database.models.group import GroupDao
from mep.database.models.mark_task import MarkTaskDao
from mep.database.models.role import Role, RoleCreate, RoleDao, RoleUpdate
from mep.database.models.role_access import RoleRefresh, RoleAccessDao, AccessType
...
from mep.utils.constants import CAPTCHA_PREFIX, RSA_KEY, USER_PASSWORD_ERROR, USER_CURRENT_SESSION
...
async def sso(*, request: Request, user: UserCreate, auth_jwt: AuthJwt = Depends()):
    ...
    if settings.get_system_login_method().mep_pro:  # Judgingsso Open or not

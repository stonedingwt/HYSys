...
from mep.knowledge.rag.elasticsearch_factory import ElasticsearchFactory
from mep.knowledge.rag.milvus_factory import MilvusFactory
...
class KnowledgeRag:
    ...
    async def init_knowledge_milvus_vectorstore(cls, invoke_user_id: int, knowledge: Knowledge = None,
        ...
        embedding = await LLMService.get_mep_knowledge_embedding(model_id=int(knowledge.model),
    ...
    def init_knowledge_milvus_vectorstore_sync(cls, invoke_user_id: int, knowledge: Knowledge = None,
        ...
        embedding = LLMService.get_mep_knowledge_embedding_sync(model_id=int(knowledge.model),
                                                                    invoke_user_id=invoke_user_id)
        return cls.init_milvus_vectorstore(knowledge.collection_name, embedding, **kwargs)
